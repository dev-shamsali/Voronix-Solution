...
export default function About() {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-[#020617]/80 to-[#040B16]/90">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {sections.map((item, idx) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-[#00A8FF]/10 to-[#005DFF]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl"></div>
        ...
        <h3 className="text-3xl font-bold text-center mb-10">
          What{" "}
          <span className="bg-gradient-to-r from-[#00A8FF] to-[#005DFF] bg-clip-text text-transparent">
            We Do
          </span>
        </h3>
